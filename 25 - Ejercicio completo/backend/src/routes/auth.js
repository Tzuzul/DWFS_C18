...
const { login, signUp, recover_session, updateRole, password_recovery, change_password } = require('../controllers/auth')
...
const auth = (app)=>{
    ...
    router.get('/recover', authMiddleware, verifyRole(['ADMIN','EDITOR','REGULAR']), recover_session)
